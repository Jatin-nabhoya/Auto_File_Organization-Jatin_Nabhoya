...
layout =[
            ...
            [sg.Text("")],[sg.Text("chose the method : ",size=(20, 1)) ,sg.Combo(['extension wise','date & time wise'],key ='choice', default_value='extension wise',readonly = True)],
            [sg.Text("")] ,
            [sg.Button("Submit", size=(8, 1))]
        ]
